...
export default function Message() {
  ...
  const columns: ColumnsType<MessageType[]> = [
    ...
    },
    {
      ...
      key: 'x',
      render: (record) => (
        <a className="btn btn-outline-danger" onClick={() => handleDelete(record.id)}>Xóa</a>
      ),
    },
  ];
  ...
  return (
    <div className='component'>
      <h4 style={{ marginLeft: "39%", paddingTop: "40px", fontWeight: "bold", color: "black" }}>DANH SÁCH THƯ GÓP Ý</h4>
